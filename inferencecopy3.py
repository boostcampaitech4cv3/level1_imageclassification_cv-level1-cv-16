...
from datasetcopy3 import TestDataset, BaseAugmentation, MaskDataset, MaskGenderDataset, IncorrectGenderDataset, NormalGenderDataset, MaskMaleDataset#, IncorrectMaleDataset, NormalMaleDataset, MaskFemaleDataset, IncorrectFemaleDataset, NormalFemaleDataset
...
def load_model(saved_model, num_classes, device, model_type):
    ...
    if model_type == 'MaskModel':
        model_cls = getattr(import_module("modelcopy3"), 'MaskModel')
        ...
        model_cls = getattr(import_module("modelcopy3"), 'MaskGenderModel')
        model = model_cls(num_classes=num_classes)
        ...
        model_cls = getattr(import_module("modelcopy3"), 'IncorrectGenderModel')
        model = model_cls(num_classes=num_classes)
        ...
        model_cls = getattr(import_module("modelcopy3"), 'NormalGenderModel')
        model = model_cls(num_classes=num_classes)
        ...
        model_cls = getattr(import_module("modelcopy3"), 'MaskMaleModel')
        model = model_cls(num_classes=num_classes)
    ...
    """
        ...
        model_cls = getattr(import_module("modelcopy3"), 'IncorrectMaleModel')
        model = model_cls(num_classes=num_classes)
        ...
        model_cls = getattr(import_module("modelcopy3"), 'NormalMaleModel')
        model = model_cls(num_classes=num_classes)
        ...
        model_cls = getattr(import_module("modelcopy3"), 'MaskFemaleModel')
        model = model_cls(num_classes=num_classes)
        ...
        model_cls = getattr(import_module("modelcopy3"), 'IncorrectFemaleModel')
        model = model_cls(num_classes=num_classes)
        ...
        model_cls = getattr(import_module("modelcopy3"), 'NormalFemaleModel')
        model = model_cls(num_classes=num_classes)
